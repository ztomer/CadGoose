// config_registry_general.cpp
// General config option registration (Common, Cursor, Movement, Physics, Spawn, Rig, Honk, Snatch, Step, Item, Mud)
#include "config.h"
...
extern void RegisterBehaviors(std::vector<ConfigOption>& r);
extern void RegisterRender(std::vector<ConfigOption>& r);
