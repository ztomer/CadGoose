...
void Config_InitRegistry() {
    ...
    // === General ===
    g_configRegistry.push_back(CONFIG_FLOAT_EX("General", "global_scale", "Global Scale",
        "Multiplier for goose size and speeds (0.1 - 10.0)",
        &g_config.general.globalScale, 0.0f, 10.0f, 0.1f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_BOOL_EX("General", "audio_enabled", "Audio Enabled",
        "Play honk sounds when goose moves",
        &g_config.general.audioEnabled, OnConfigChange));
    g_configRegistry.push_back(CONFIG_BOOL("General", "audio_muted", "Audio Muted",
        &g_config.general.audioMuted, OnConfigChange));
    g_configRegistry.push_back(CONFIG_BOOL_EX("General", "memes_enabled", "Memes Enabled",
        "Allow picking up images and text as items",
        &g_config.general.memesEnabled, OnConfigChange));
    g_configRegistry.push_back(CONFIG_INT_EX("General", "appearance_mode", "Appearance Mode",
        "0=Light, 1=Dark, 2=System (follow macOS), 3=Custom",
        &g_config.general.appearanceMode, 0, 3, OnConfigChange));
    g_configRegistry.push_back(CONFIG_STRING("General", "light_theme_role", "Light Theme Role",
        &g_config.general.lightThemeRole, OnConfigChange));
    g_configRegistry.push_back(CONFIG_STRING("General", "dark_theme_role", "Dark Theme Role",
        &g_config.general.darkThemeRole, OnConfigChange));
    g_configRegistry.push_back(CONFIG_STRING("General", "failsafe_hotkey", "Failsafe Hotkey",
    ...
    g_configRegistry.push_back(CONFIG_FLOAT("Rig", "beak_len", "Beak Length",
    ...
    // === Mud ===
    g_configRegistry.push_back(CONFIG_BOOL("Mud", "mud_enabled", "Mud Enabled",
        &g_config.mud.enabled, OnConfigChange));
    g_configRegistry.push_back(CONFIG_INT("Mud", "mud_chance", "Mud Chance",
        &g_config.mud.chance, 0, 100, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Mud", "mud_lifetime", "Mud Lifetime",
        &g_config.mud.lifetime, 0.0f, 60.0f, 1.0f, OnConfigChange));

    // === Honk ===
    g_configRegistry.push_back(CONFIG_FLOAT("Honk", "honk_min_gap", "Honk Min Gap",
        &g_config.honk.minGap, 0.0f, 5.0f, 0.1f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Honk", "honk_idle_min", "Honk Idle Min",
        &g_config.honk.idleMin, 0.0f, 30.0f, 1.0f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Honk", "honk_idle_max", "Honk Idle Max",
        &g_config.honk.idleMax, 0.0f, 60.0f, 1.0f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Honk", "honk_chase_cooldown", "Honk Chase Cooldown",
    ...
    // === Step ===
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_time_fetch", "Step Time Fetch",
        &g_config.step.timeFetch, 0.0f, 1.0f, 0.01f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_time_wander", "Step Time Wander",
        &g_config.step.timeWander, 0.0f, 1.0f, 0.01f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_duration_walk", "Step Duration Walk",
        &g_config.step.durationWalk, 0.0f, 1.0f, 0.01f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_duration_run", "Step Duration Run",
        &g_config.step.durationRun, 0.0f, 1.0f, 0.01f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_lift_walk", "Step Lift Walk",
        &g_config.step.liftWalk, 0.0f, 20.0f, 1.0f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Step", "step_lift_run", "Step Lift Run",
    ...
    // === Item ===
    g_configRegistry.push_back(CONFIG_FLOAT("Item", "item_pickup_cooldown", "Item Pickup Cooldown",
    ...
    g_configRegistry.push_back(CONFIG_FLOAT("Item", "meme_lifetime", "Meme Lifetime",
        &g_config.item.memeLifetime, 0.0f, 120.0f, 1.0f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Item", "text_lifetime", "Text Lifetime",
        &g_config.item.textLifetime, 0.0f, 120.0f, 1.0f, OnConfigChange));
    g_configRegistry.push_back(CONFIG_INT("Item", "max_dropped_memes", "Max Dropped Memes",
        &g_config.item.maxDroppedMemes, 0, 100, OnConfigChange));
    g_configRegistry.push_back(CONFIG_INT("Item", "max_dropped_texts", "Max Dropped Texts",
        &g_config.item.maxDroppedTexts, 0, 100, OnConfigChange));
    g_configRegistry.push_back(CONFIG_FLOAT("Item", "item_fetch_cooldown", "Item Fetch Cooldown",
