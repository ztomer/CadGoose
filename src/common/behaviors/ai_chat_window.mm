// ai_chat_window.mm
// The AI chat window: controller implementation, extern "C" chat API and the
// Foundation fallback-response helpers. Split out of behavior_ai.mm, which now
// only registers the behavior.
...
#import "ai_chat_window_internal.h"
