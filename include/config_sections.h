// config_sections.h
// Per-section config structs (Debug/General/.../Behavior). Included by
// config.h so existing #include sites stay unchanged; do not include directly.

#ifndef CONFIG_SECTIONS_H
#define CONFIG_SECTIONS_H
